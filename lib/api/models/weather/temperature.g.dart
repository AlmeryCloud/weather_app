...
class TemperatureAdapter extends TypeAdapter<_$_Temperature> {
  @override
  final int typeId = 2;

  @override
  _$_Temperature read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return _$_Temperature(
  ...
  @override
  void write(BinaryWriter writer, _$_Temperature obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.day)
